...
public class GenericAppLogger implements ILoggerAplicacion {
	...
	private boolean esImprimible(LEVEL nivel)
	{
		...
		try
		{
			...
			{res=true;}
			else if (modo.equalsIgnoreCase(LEVEL.FINE.toString()))
			{
				if (nivel.equals(LEVEL.FINE)||nivel.equals(LEVEL.INFO)|| nivel.equals(LEVEL.WARNING)|| nivel.equals(LEVEL.SEVERE))
				{res=true;}
				else {res=false;}
			}
	...
	/* (non-Javadoc)
	 * @see es.tributasenasturias.utils.Log.ILoggerAplicacion#fine(java.lang.String)
	 */
	@Override
	public void fine(String msg) {
		if (esImprimible(LEVEL.FINE))
		{doLog(msg,LEVEL.FINE);}
	}
